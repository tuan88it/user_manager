...
class MockUserCoreData: UserCoreData {
    ...
    var savedUserDetail: UserDetail = UserDetail(userId: 101, name: "Jayson Vantuyl", login: "jvantuyl", avatarUrl: "https://avatars.githubusercontent.com/u/101?v=4", htmlUrl: "https://github.com/jvantuyl", location: "Plumas County, California, USA", followers: 66, following: 15)
...
class MockDataMapper: DataMapper {
    ...
    func map(_ dto: UserDetailDTO) -> UserDetail {
        return UserDetail(userId: dto.id, name: dto.name, login: dto.login, avatarUrl: dto.avatarUrl, htmlUrl: dto.htmlUrl, location: dto.location, followers: dto.followers ?? 0, following: dto.following ?? 0)
    }
}
